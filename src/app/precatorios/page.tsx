    ...
    <div className="precatorios-page">
      ...
      <style jsx>{`
        ...
        .hero {
          ...
          display: flex;
          align-items: center;
          background: radial-gradient(circle at top right, rgba(194, 161, 95, 0.08), transparent 40%);
        }
        ...
        .info-box {
           background: linear-gradient(135deg, #0a1118, #121d26);
           padding: 4rem;
           border-radius: 32px;
        ...
        .bg-gold-gradient {
          background: linear-gradient(135deg, #001F26, #002B36);
          border-top: 1px solid rgba(194, 161, 95, 0.1);
          border-bottom: 1px solid rgba(194, 161, 95, 0.1);
        }
        ...
        .final-cta {
          padding: 6rem;
          background: radial-gradient(circle at center, rgba(194, 161, 95, 0.05), transparent);
        }
